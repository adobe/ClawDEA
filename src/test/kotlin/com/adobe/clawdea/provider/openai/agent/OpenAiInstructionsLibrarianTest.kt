...
class OpenAiInstructionsLibrarianTest : BasePlatformTestCase() {
    fun test_openai_instructions_name_the_mcp_tool_not_subagent() {
        ClawDEASettings.getInstance().state.enableWikiLibrarian = true
        val text = OpenAiInstructions.build(project, emptyList())
