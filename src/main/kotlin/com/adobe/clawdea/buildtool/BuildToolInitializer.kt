...
/**
 * Registers built-in [BuildTool] implementations on first project open.
 *
 * The registry is process-wide, so re-running for additional projects is idempotent
 * (register replaces by id, preserves registration order).
 *
 ...
 * historical default ClawDEA assumed; Maven follows.
 */
